...
//   return (
//     // <div className="relative w-full h-[80vh] flex items-center justify-center overflow-hidden bg-transparent">
//       <div className="relative w-full h-[90vh] sm:h-[80vh] flex items-start sm:items-center justify-center sm:justify-center overflow-hidden bg-transparent pt-12 sm:pt-0">

//       {/* Hero Image (centered) */}
//       <motion.img
//         src="./Brand.png"
//         alt="hero"
//         className="absolute w-auto h-[100%] sm:h-[100%] max-h-[90vh] -mt-12 sm:mt-8 object-contain z-0 opacity-80"
...
//       <div className="absolute inset-0 bg-gradient-to-b from-lime/100 via-black/30 to-pink/40- z-10 min-h-[50vh] sm:min-h-[80vh]
// "></div>

//       {/* Centered Text Content */}
//       <div className="relative z-20 text-center mt-10 sm:mt-8 px-6">
//      <motion.h1
//   className="text-5xl md:text-7xl lg:text-[8rem] text-white text-center "
//   initial={{ opacity: 0 }}
//   animate={{ opacity: 1 }}
...
//         <motion.p
//           className="mt-4  text-xl md:text-3xl text-white font-medium soft-glow"
...
//       border-white
//       bg-transparent
//       hover:bg-white hover:text-[#895a4f]
